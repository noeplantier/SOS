        ...
        for (const [nodeCredentialType, nodeCredentials] of allNodeCredentials) {
            if (typeof nodeCredentials === 'string' || nodeCredentials.id === null) {
                ...
                if (credentialsByName[nodeCredentialType][name] === undefined) {
                    const credentials = await di_1.Container.get(credentials_repository_1.CredentialsRepository).findBy({
                        name,
            ...
            if (credentialsById[nodeCredentialType][nodeCredentials.id] === undefined) {
                const credentials = await di_1.Container.get(credentials_repository_1.CredentialsRepository).findOneBy({
                ...
                const credsByName = await di_1.Container.get(credentials_repository_1.CredentialsRepository).findBy({
...
async function getVariables() {
    const variables = await di_1.Container.get(variables_service_ee_1.VariablesService).getAllCached();
