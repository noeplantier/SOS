...
let SharedWorkflowRepository = class SharedWorkflowRepository extends typeorm_1.Repository {
    constructor(dataSource) {
        super(db_1.SharedWorkflow, dataSource.manager);
    }
    ...
    async makeOwner(workflowIds, projectId, trx) {
        ...
        return await trx.upsert(db_1.SharedWorkflow, workflowIds.map((workflowId) => ({
            workflowId,
            projectId,
            role: 'workflow:owner',
    ...
    async deleteByIds(sharedWorkflowIds, projectId, trx) {
        trx = trx ?? this.manager;
        return await trx.delete(db_1.SharedWorkflow, {
            projectId,
    ...
    async findWorkflowWithOptions(workflowId, options = {}) {
        ...
        return await em.findOne(db_1.SharedWorkflow, {
            where: {
                workflowId,
                ...where,
            },
