...
class ImportWorkflowsCommand extends base_command_1.BaseCommand {
    ...
    async getWorkflowOwner(workflowId) {
        const sharing = await di_1.Container.get(shared_workflow_repository_1.SharedWorkflowRepository).findOne({
    ...
    async getProject(userId, projectId) {
        if (projectId) {
            return await di_1.Container.get(project_repository_1.ProjectRepository).findOneByOrFail({ id: projectId });
        }
        if (!userId) {
        ...
        return await di_1.Container.get(project_repository_1.ProjectRepository).getPersonalProjectForUserOrFail(userId);
    }
}
