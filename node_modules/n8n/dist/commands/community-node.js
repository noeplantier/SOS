...
const installed_nodes_repository_1 = require("../databases/repositories/installed-nodes.repository");
...
class CommunityNode extends base_command_1.BaseCommand {
    ...
    async findCredentialsByType(credentialType) {
        return await di_1.Container.get(credentials_repository_1.CredentialsRepository).findBy({ type: credentialType });
    }
