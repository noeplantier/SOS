...
export declare class EnterpriseCredentialsService {
    ...
    constructor(sharedCredentialsRepository: SharedCredentialsRepository, ownershipService: OwnershipService, credentialsService: CredentialsService, projectService: ProjectService, roleService: RoleService, credentialsFinderService: CredentialsFinderService);
