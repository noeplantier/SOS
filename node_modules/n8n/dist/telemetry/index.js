...
let Telemetry = class Telemetry {
    ...
    async pulse() {
        ...
        const pulsePacket = {
            ...
            team_projects: (await di_1.Container.get(project_repository_1.ProjectRepository).getProjectCounts()).team,
            project_role_count: await di_1.Container.get(project_relation_repository_1.ProjectRelationRepository).countUsersByRole(),
        };
