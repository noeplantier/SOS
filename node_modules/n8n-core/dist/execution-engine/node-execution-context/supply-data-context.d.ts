...
export declare class SupplyDataContext extends BaseExecuteContext implements ISupplyDataFunctions {
    ...
    addInputData(connectionType: AINodeConnectionType, data: INodeExecutionData[][]): {
        index: number;
    };
    addOutputData(connectionType: AINodeConnectionType, currentNodeRunIndex: number, data: INodeExecutionData[][] | ExecutionBaseError, metadata?: ITaskMetadata): void;
    addExecutionDataFunctions(type: 'input' | 'output', data: INodeExecutionData[][] | ExecutionBaseError, connectionType: AINodeConnectionType, sourceNodeName: string, currentNodeRunIndex: number, metadata?: ITaskMetadata): Promise<void>;
}
