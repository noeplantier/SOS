const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-5d-cSdiS.js","assets/index-B6eunbxp.js","assets/index-DCpy4nCU.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-2QD4wPLR.js","assets/chartjs.utils-Dk1WO3Mr.js","assets/InsightsSummary-gldDQ9rg.js","assets/InsightsSummary-CdlaUpAt.css","assets/index-Br8T1Gn6.js","assets/InsightsChartFailed-IZ-KYOU9.js","assets/InsightsChartFailureRate-2fWw3p0L.js","assets/InsightsChartTimeSaved-B2pLVys1.js","assets/InsightsChartAverageRuntime-Boh0SMb3.js","assets/InsightsTableWorkflows-_eTCUNCX.js","assets/InsightsTableWorkflows-Blv_GPUj.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, ge as useModel, h3 as useInsightsStore, r as ref, ho as UNLICENSED_TIME_RANGE, h9 as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, i as createElementBlock, F as Fragment, D as renderList, m as unref, ed as _sfc_main$3, l as createTextVNode, f as createCommentVNode, t as toDisplayString, k as createBaseVNode, ee as N8nSelect, q as computed, c as useI18n, j as createVNode, be as N8nText, bg as N8nButton, hp as ElDialog, a6 as usePageRedirectionHelper, _ as _export_sfc, c3 as defineAsyncComponent, X as watch, h as resolveComponent, n as normalizeClass, b6 as resolveDynamicComponent, ao as __vitePreload, ag as useTelemetry, hq as TELEMETRY_TIME_RANGE } from "./index-B6eunbxp.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-5d-cSdiS.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-2QD4wPLR.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-IZ-KYOU9.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-2fWw3p0L.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-B2pLVys1.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-Boh0SMb3.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-_eTCUNCX.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
