...
var CompareDatasets_node_exports = {};
__export(CompareDatasets_node_exports, {
  CompareDatasets: () => CompareDatasets
});
module.exports = __toCommonJS(CompareDatasets_node_exports);
...
class CompareDatasets {
  ...
  async execute() {
    const matchFields = (0, import_GenericFunctions.checkMatchFieldsInput)(
    ...
    if (options.nodeVersion < 2.2) {
      input1 = (0, import_GenericFunctions.checkInputAndThrowError)(
        input1,
        matchFields.map((pair) => pair.field1),
        options.disableDotNotation || false,
        "Input A"
      );
      input2 = (0, import_GenericFunctions.checkInputAndThrowError)(
        input2,
      ...
      input1 = (0, import_GenericFunctions.checkInput)(input1);
      input2 = (0, import_GenericFunctions.checkInput)(input2);
    }
    ...
    const matches = (0, import_GenericFunctions.findMatches)(input1, input2, matchFields, options);
    return matches;
  }
}
