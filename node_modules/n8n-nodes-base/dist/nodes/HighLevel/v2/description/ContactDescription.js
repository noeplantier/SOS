    ...
    options: [
      {
        ...
        routing: {
          ...
          send: {
            preSend: [
              import_GenericFunctions.validEmailAndPhonePreSendAction,
              import_GenericFunctions.splitTagsPreSendAction,
              import_GenericFunctions.addLocationIdPreSendAction,
              import_GenericFunctions.addCustomFieldsPreSendAction
            ]
          },
          output: {
            postReceive: [
              ...
              import_GenericFunctions.addNotePostReceiveAction
            ]
          }
        },
      ...
      },
      {
        ...
        routing: {
          ...
          send: {
            preSend: [import_GenericFunctions.validEmailAndPhonePreSendAction, import_GenericFunctions.splitTagsPreSendAction]
          },
          output: {
            postReceive: [
              {
...
const getAllProperties = [
  ...
  },
  {
    ...
    routing: {
      ...
      output: {
        maxResults: "={{$value}}"
        // Set maxResults to the value of current parameter
      }
    },
