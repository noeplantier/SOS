...
__export(GenericFunctions_exports, {
  hunterApiRequest: () => hunterApiRequest,
  hunterApiRequestAllItems: () => hunterApiRequestAllItems
});
...
async function hunterApiRequestAllItems(propertyName, method, resource, body = {}, query = {}) {
  ...
  } while (responseData.meta?.results !== void 0 && responseData.meta.offset <= responseData.meta.results);
  return returnData;
}
