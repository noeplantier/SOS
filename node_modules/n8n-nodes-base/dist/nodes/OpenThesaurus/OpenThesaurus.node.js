...
var OpenThesaurus_node_exports = {};
__export(OpenThesaurus_node_exports, {
  OpenThesaurus: () => OpenThesaurus
});
module.exports = __toCommonJS(OpenThesaurus_node_exports);
    ...
    for (let i = 0; i < length; i++) {
      try {
        if (operation === "getSynonyms") {
          ...
          responseData = await import_GenericFunctions.openThesaurusApiRequest.call(
            this,
            "GET",
            "/synonyme/search",
            {},
