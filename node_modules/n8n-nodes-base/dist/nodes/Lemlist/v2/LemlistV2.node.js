...
var LemlistV2_node_exports = {};
__export(LemlistV2_node_exports, {
  LemlistV2: () => LemlistV2
});
module.exports = __toCommonJS(LemlistV2_node_exports);
...
const versionDescription = {
  ...
  properties: [
    ...
    ...import_descriptions.enrichmentOperations,
    ...import_descriptions.enrichmentFields,
      ...
      try {
        if (resource === "activity") {
          ...
          if (operation === "get") {
            ...
            responseData = await import_GenericFunctions.lemlistApiRequest.call(this, "GET", "/team/credits");
          }
          ...
          if (operation === "get") {
            ...
            responseData = await import_GenericFunctions.lemlistApiRequest.call(this, "GET", `/enrich/${enrichId}`);
