...
var InvoiceNinja_node_exports = {};
__export(InvoiceNinja_node_exports, {
  InvoiceNinja: () => InvoiceNinja
});
module.exports = __toCommonJS(InvoiceNinja_node_exports);
var import_n8n_workflow = require("n8n-workflow");
var import_ISOCountryCodes = require("../../utils/ISOCountryCodes");
var import_BankTransactionDescription = require("./BankTransactionDescription");
...
var import_QuoteDescription = require("./QuoteDescription");
  ...
  constructor() {
    this.description = {
      ...
      properties: [
        ...
        ...import_QuoteDescription.quoteOperations,
        ...import_QuoteDescription.quoteFields,
        ...import_BankTransactionDescription.bankTransactionOperations,
        ...import_BankTransactionDescription.bankTransactionFields
      ]
    };
    this.methods = {
      loadOptions: {
        ...
        async getClients() {
          const returnData = [];
          const clients = await import_GenericFunctions.invoiceNinjaApiRequestAllItems.call(this, "data", "GET", "/clients");
        ...
        async getProjects() {
          const returnData = [];
          const projects = await import_GenericFunctions.invoiceNinjaApiRequestAllItems.call(
            this,
            "data",
            "GET",
            "/projects"
        ...
        async getInvoices() {
          const returnData = [];
          const invoices = await import_GenericFunctions.invoiceNinjaApiRequestAllItems.call(
            this,
            "data",
            "GET",
            "/invoices"
        ...
        async getCountryCodes() {
          const returnData = [];
          for (let i = 0; i < import_ISOCountryCodes.isoCountryCodes.length; i++) {
            const countryName = import_ISOCountryCodes.isoCountryCodes[i].name;
            const countryId = import_ISOCountryCodes.isoCountryCodes[i].numeric;
            returnData.push({
              name: countryName,
              value: countryId
            });
        ...
        async getVendors() {
          const returnData = [];
          const vendors = await import_GenericFunctions.invoiceNinjaApiRequestAllItems.call(this, "data", "GET", "/vendors");
        ...
        async getExpenseCategories() {
          const returnData = [];
          const categories = await import_GenericFunctions.invoiceNinjaApiRequestAllItems.call(
            this,
            "data",
            "GET",
            "/expense_categories"
        ...
        async getBankIntegrations() {
          const returnData = [];
          let banks = await import_GenericFunctions.invoiceNinjaApiRequestAllItems.call(
            this,
            "data",
            "GET",
            "/bank_integrations"
        ...
        async getPayments() {
          ...
          const payments = await import_GenericFunctions.invoiceNinjaApiRequestAllItems.call(
            this,
            "data",
            "GET",
            "/payments",
          ...
          for (const payment of payments) {
            const paymentName = [payment.number, payment.date, payment.amount].filter((e) => e).join(" - ");
        ...
        async getCurrencies() {
          const returnData = [];
          const statics = await import_GenericFunctions.invoiceNinjaApiRequestAllItems.call(this, "data", "GET", "/statics");
          Object.entries(statics).filter(([key]) => key === "currencies").forEach(([key, value]) => {
      ...
      try {
        if (resource === "client") {
          if (operation === "create") {
            ...
            responseData = await import_GenericFunctions.invoiceNinjaApiRequest.call(
              this,
              "POST",
              "/clients",
              body
          ...
          if (operation === "getAll") {
            ...
            if (returnAll) {
              responseData = await import_GenericFunctions.invoiceNinjaApiRequestAllItems.call(
                this,
                "data",
                "GET",
                "/clients",
              ...
              responseData = await import_GenericFunctions.invoiceNinjaApiRequest.call(this, "GET", "/clients", {}, qs);
              responseData = responseData.data;
            }
          }
          if (operation === "delete") {
        ...
        if (resource === "invoice") {
          if (operation === "create") {
            ...
            const invoiceItemsValues = this.getNodeParameter("invoiceItemsUi", i).invoiceItemsValues;
          ...
          if (operation === "email") {
            ...
            if (apiVersion === "v4") {
              responseData = await import_GenericFunctions.invoiceNinjaApiRequest.call(this, "POST", "/email_invoice", {
                id: invoiceId
              });
            }
            if (apiVersion === "v5") {
          ...
          if (operation === "getAll") {
            ...
            if (returnAll) {
              ...
              qs.per_page = this.getNodeParameter("limit", 0);
              responseData = await import_GenericFunctions.invoiceNinjaApiRequest.call(this, "GET", "/invoices", {}, qs);
              responseData = responseData.data;
            }
          }
          if (operation === "delete") {
        ...
        if (resource === "task") {
            ...
            if (timeLogsValues) {
              ...
              for (const logValue of timeLogsValues) {
                ...
                if (logValue.startDate) {
                  from = new Date(logValue.startDate).getTime() / 1e3;
                }
                if (logValue.endDate) {
                  to = new Date(logValue.endDate).getTime() / 1e3;
                }
          ...
          if (operation === "getAll") {
            ...
            if (returnAll) {
              ...
              qs.per_page = this.getNodeParameter("limit", 0);
              responseData = await import_GenericFunctions.invoiceNinjaApiRequest.call(this, "GET", "/tasks", {}, qs);
              responseData = responseData.data;
            }
          }
          if (operation === "delete") {
            const taskId = this.getNodeParameter("taskId", i);
            responseData = await import_GenericFunctions.invoiceNinjaApiRequest.call(this, "DELETE", `/tasks/${taskId}`);
            responseData = responseData.data;
          }
        }
        if (resource === "payment") {
          if (operation === "create") {
            ...
            const client = (await import_GenericFunctions.invoiceNinjaApiRequest.call(this, "GET", `/invoices/${invoice}`, {}, qs)).data?.client_id;
          ...
          if (operation === "getAll") {
            ...
            if (returnAll) {
              ...
              qs.per_page = this.getNodeParameter("limit", 0);
              responseData = await import_GenericFunctions.invoiceNinjaApiRequest.call(this, "GET", "/payments", {}, qs);
              responseData = responseData.data;
            }
          }
          if (operation === "delete") {
        ...
        if (resource === "expense") {
          ...
          if (operation === "getAll") {
            ...
            if (returnAll) {
              ...
              qs.per_page = this.getNodeParameter("limit", 0);
              responseData = await import_GenericFunctions.invoiceNinjaApiRequest.call(this, "GET", "/expenses", {}, qs);
              responseData = responseData.data;
            }
          }
          if (operation === "delete") {
