...
var ItemListsV1_node_exports = {};
__export(ItemListsV1_node_exports, {
  ItemListsV1: () => ItemListsV1
});
module.exports = __toCommonJS(ItemListsV1_node_exports);
      ...
      if (operation === "splitOutItems") {
        for (let i = 0; i < length; i++) {
          ...
          if (!disableDotNotation) {
            arrayToSplit = (0, import_get.default)(items[i].json, fieldToSplitOut);
          } else {
              ...
              if (include === "selectedOtherFields") {
                ...
                newItem = {
                  ...fieldsToInclude.reduce((prev, field) => {
                    ...
                    let value;
                    if (!disableDotNotation) {
                      value = (0, import_get.default)(items[i].json, field);
                    } else {
                ...
                (0, import_unset.default)(newItem, fieldToSplitOut);
              }
