    ...
    options: [
      ...
      // Get Operation
      {
        ...
        routing: {
          ...
          output: {
            postReceive: [import_UserFunctions.simplifyGetResponse]
          }
        },
        action: "Get a user"
      },
      // Get All Operation
      {
        ...
        routing: {
          ...
          output: {
            postReceive: [import_UserFunctions.simplifyGetAllResponse]
          },
          send: {
            paginate: true
          },
          operations: {
            pagination: (0, import_UserFunctions.getCursorPaginator)()
          }
        },
...
const updateFields = createFields.concat(mainProfileFields).sort((a, b) => a.displayName.localeCompare(b.displayName));
const userFields = [
