...
var AppointmentDescription_exports = {};
__export(AppointmentDescription_exports, {
  appointmentFields: () => appointmentFields,
  appointmentOperations: () => appointmentOperations
});
module.exports = __toCommonJS(AppointmentDescription_exports);
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        options: import_moment_timezone.tz.names().map((timeZone) => ({ name: timeZone, value: timeZone }))
      }
    ]
  },
  // ----------------------------------------
