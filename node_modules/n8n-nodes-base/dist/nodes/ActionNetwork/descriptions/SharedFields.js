...
__export(SharedFields_exports, {
  eventAdditionalFieldsOptions: () => eventAdditionalFieldsOptions,
...
const postalAddressesFields = [
  ...
  },
  {
    ...
    name: "address_lines",
    type: "string",
    // The Action Network API expects a string array but ignores any string beyond the first, so this input field is simplified to string.
    default: "",
...
const eventAdditionalFieldsOptions = [
  {
...
const personAdditionalFieldsOptions = [
  {
  ...
  },
  {
    ...
    type: "options",
    // Action Network accepts a `string[]` of language codes, but supports only one language per person - sending an array of 2+ languages will result in the first valid language being set as the preferred language for the person. Therefore, the user may select only one option in the n8n UI.
    default: [],
...
const petitionAdditionalFieldsOptions = [
  {
    displayName: "Browser URL",
    name: "browser_url",
    type: "string",
