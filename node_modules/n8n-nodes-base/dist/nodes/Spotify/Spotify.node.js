...
var Spotify_node_exports = {};
__export(Spotify_node_exports, {
  Spotify: () => Spotify
});
module.exports = __toCommonJS(Spotify_node_exports);
      ...
      try {
        if (resource === "player") {
          if (operation === "pause") {
            ...
            responseData = await import_GenericFunctions.spotifyApiRequest.call(this, requestMethod, endpoint, body, qs);
          ...
          if (["delete", "get", "getTracks", "add"].includes(operation)) {
            ...
            if (operation === "delete") {
              ...
              if (!returnAll) {
                ...
                responseData = await import_GenericFunctions.spotifyApiRequest.call(
                  this,
                  requestMethod,
                  endpoint,
                  body,
              ...
              if (additionalFields.position !== void 0) {
            ...
            responseData = await import_GenericFunctions.spotifyApiRequest.call(this, "POST", "/me/playlists", body, qs);
          } else if (operation === "search") {
            requestMethod = "GET";
            endpoint = "/search";
        ...
        if (returnAll) {
          responseData = await import_GenericFunctions.spotifyApiRequestAllItems.call(
            this,
            propertyName,
            requestMethod,
            endpoint,
