...
var Markdown_node_exports = {};
__export(Markdown_node_exports, {
  Markdown: () => Markdown
});
module.exports = __toCommonJS(Markdown_node_exports);
var import_isEmpty = __toESM(require("lodash/isEmpty"));
var import_set = __toESM(require("lodash/set"));
var import_n8n_workflow = require("n8n-workflow");
var import_node_html_markdown = require("node-html-markdown");
var import_showdown = require("showdown");
class Markdown {
  constructor() {
    this.description = {
    ...
    for (let i = 0; i < length; i++) {
      try {
        if (mode === "htmlToMarkdown") {
          ...
          options.textReplace = !(0, import_isEmpty.default)(textReplaceOption) ? textReplaceOption.map((entry) => [entry.pattern, entry.replacement]) : void 0;
          const lineStartEscapeOption = this.getNodeParameter(
            "options.lineStartEscape.value",
            i,
            {}
          );
          options.lineStartEscape = !(0, import_isEmpty.default)(lineStartEscapeOption) ? [lineStartEscapeOption.pattern, lineStartEscapeOption.replacement] : void 0;
          const globalEscapeOption = this.getNodeParameter(
            "options.globalEscape.value",
            i,
            {}
          );
          options.globalEscape = !(0, import_isEmpty.default)(globalEscapeOption) ? [globalEscapeOption.pattern, globalEscapeOption.replacement] : void 0;
          options.ignore = options.ignore ? options.ignore.split(",").map((element) => element.trim()) : void 0;
          options.blockElements = options.blockElements ? options.blockElements.split(",").map((element) => element.trim()) : void 0;
          ...
          const markdownFromHTML = import_node_html_markdown.NodeHtmlMarkdown.translate(html, markdownOptions);
          const newItem = (0, import_n8n_workflow.deepCopy)(items[i].json);
          (0, import_set.default)(newItem, destinationKey, markdownFromHTML);
        ...
        if (mode === "markdownToHtml") {
          ...
          const newItem = (0, import_n8n_workflow.deepCopy)(items[i].json);
          (0, import_set.default)(newItem, destinationKey, htmlFromMarkdown);
          returnData.push(newItem);
        }
      } catch (error) {
