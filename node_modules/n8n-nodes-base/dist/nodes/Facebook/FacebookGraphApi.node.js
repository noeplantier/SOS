...
var FacebookGraphApi_node_exports = {};
__export(FacebookGraphApi_node_exports, {
  FacebookGraphApi: () => FacebookGraphApi
});
module.exports = __toCommonJS(FacebookGraphApi_node_exports);
  ...
  async execute() {
    ...
    for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
      ...
      if (options !== void 0) {
        ...
        if (options.queryParameters !== void 0) {
          const queryParameters = options.queryParameters;
          if (queryParameters.parameter !== void 0) {
      ...
      if (typeof response === "string") {
        if (!this.continueOnFail()) {
          throw new import_n8n_workflow.NodeOperationError(this.getNode(), "Response body is not valid JSON.", {
            itemIndex
          });
        }
