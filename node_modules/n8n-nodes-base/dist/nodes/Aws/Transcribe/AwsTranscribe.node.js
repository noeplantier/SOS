...
var AwsTranscribe_node_exports = {};
__export(AwsTranscribe_node_exports, {
  AwsTranscribe: () => AwsTranscribe
});
module.exports = __toCommonJS(AwsTranscribe_node_exports);
        ...
        if (resource === "transcriptionJob") {
          ...
          if (operation === "get") {
            ...
            if (resolve && responseData.TranscriptionJobStatus === "COMPLETED") {
              ...
              if (simple) {
                responseData = {
                  transcript: responseData.results.transcripts.map((data) => data.transcript).join(" ")
                };
              }
            }
          }
