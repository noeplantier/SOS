...
var AwsS3V1_node_exports = {};
__export(AwsS3V1_node_exports, {
  AwsS3V1: () => AwsS3V1
});
module.exports = __toCommonJS(AwsS3V1_node_exports);
      ...
      try {
        if (resource === "bucket") {
          ...
          if (operation === "search") {
            ...
            qs["list-type"] = 2;
            responseData = await import_GenericFunctions.awsApiRequestSOAP.call(this, `${bucketName}.s3`, "GET", "", "", {
              location: ""
            });
        ...
        if (resource === "file") {
          ...
          if (operation === "download") {
            ...
            let region = await import_GenericFunctions.awsApiRequestSOAP.call(this, `${bucketName}.s3`, "GET", "", "", {
              location: ""
            });
