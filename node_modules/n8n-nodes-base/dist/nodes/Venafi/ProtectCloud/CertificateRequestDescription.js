...
var CertificateRequestDescription_exports = {};
__export(CertificateRequestDescription_exports, {
  certificateRequestFields: () => certificateRequestFields,
  certificateRequestOperations: () => certificateRequestOperations
});
module.exports = __toCommonJS(CertificateRequestDescription_exports);
const certificateRequestOperations = [
  {
...
const certificateRequestFields = [
  /* -------------------------------------------------------------------------- */
