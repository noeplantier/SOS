...
__export(apiResponses_exports, {
  getAllSubscribersResponseClassic: () => getAllSubscribersResponseClassic,
  getAllSubscribersResponseV2: () => getAllSubscribersResponseV2,
  ...
  getUpdateSubscriberResponseClassic: () => getUpdateSubscriberResponseClassic,
  getUpdateSubscriberResponseV2: () => getUpdateSubscriberResponseV2
});
module.exports = __toCommonJS(apiResponses_exports);
const getUpdateSubscriberResponseClassic = {
  id: 1343965485,
...
const getSubscriberResponseClassic = {
  id: 1343965485,
  name: "John",
  email: "demo@mailerlite.com",
  sent: 0,
...
const getCreateResponseClassic = {
  id: 1343965485,
  name: "John",
  email: "demo@mailerlite.com",
  sent: 0,
...
const getAllSubscribersResponseClassic = [
  {
    id: 1343965485,
    name: "John",
    email: "demo@mailerlite.com",
...
const getUpdateSubscriberResponseV2 = {
  data: {
...
const getAllSubscribersResponseV2 = {
  data: [
    {
      id: "139872142007207563",
      email: "user@n8n.io",
