...
__export(GenericFunctions_exports, {
  ...
  getAddressesUi: () => getAddressesUi,
  getCustomerOptionalFields: () => getCustomerOptionalFields,
  getFilterQuery: () => getFilterQuery,
  getOrderFields: () => getOrderFields,
  getProductAttributes: () => getProductAttributes,
  getProductOptionalFields: () => getProductOptionalFields,
  getSearchFilters: () => getSearchFilters,
  magentoApiRequest: () => magentoApiRequest,
  magentoApiRequestAllItems: () => magentoApiRequestAllItems,
  sort: () => sort,
...
function getFilterQuery(data) {
  if (!data.hasOwnProperty("conditions") || data.conditions?.length === 0) {
    throw new import_n8n_workflow.ApplicationError("At least one filter has to be set", { level: "warning" });
  }
...
async function getProductAttributes(filter, extraValue) {
  let attributes = await magentoApiRequestAllItems.call(
    this,
    "items",
    "GET",
  ...
  attributes = attributes.filter(
    (attribute) => attribute.default_frontend_label !== void 0 && attribute.default_frontend_label !== ""
  );
  if (filter) {
