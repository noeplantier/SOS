...
var Base_resource_exports = {};
__export(Base_resource_exports, {
  description: () => description,
  getMany: () => getMany,
  getSchema: () => getSchema
});
module.exports = __toCommonJS(Base_resource_exports);
var getMany = __toESM(require("./getMany.operation"));
var getSchema = __toESM(require("./getSchema.operation"));
const description = [
  {
