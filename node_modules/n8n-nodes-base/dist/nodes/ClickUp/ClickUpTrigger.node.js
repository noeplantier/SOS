...
var ClickUpTrigger_node_exports = {};
__export(ClickUpTrigger_node_exports, {
  ClickUpTrigger: () => ClickUpTrigger
});
module.exports = __toCommonJS(ClickUpTrigger_node_exports);
...
class ClickUpTrigger {
    ...
    this.webhookMethods = {
      default: {
        async checkExists() {
          ...
          const { webhooks } = await import_GenericFunctions.clickupApiRequest.call(this, "GET", endpoint);
        ...
        async create() {
          ...
          const { webhook } = await import_GenericFunctions.clickupApiRequest.call(this, "POST", endpoint, body);
        ...
        async delete() {
          ...
          try {
            await import_GenericFunctions.clickupApiRequest.call(this, "DELETE", endpoint);
          } catch (error) {
            return false;
          }
  ...
  async webhook() {
    ...
    const computedSignature = (0, import_crypto.createHmac)("sha256", webhookData.secret).update(JSON.stringify(req.body)).digest("hex");
