...
var MessageBird_node_exports = {};
__export(MessageBird_node_exports, {
  MessageBird: () => MessageBird
});
module.exports = __toCommonJS(MessageBird_node_exports);
  ...
  async execute() {
    ...
    for (let i = 0; i < items.length; i++) {
      ...
      try {
        ...
        const responseData = await import_GenericFunctions.messageBirdApiRequest.call(
          this,
          requestMethod,
          requestPath,
          bodyRequest,
