...
const messageFields = [
  ...
  },
  {
    ...
    default: {},
    // TODO: Remove comment: has to make default array for the main property, check where that happens in UI
        ...
        options: [
          {
            ...
            values: [
              ...
              },
              {
                ...
                description: 'Only used if sending message as a bot. Use emoji codes like +1, not an actual emoji like \u{1F44D}. <a target="_blank" href=" https://www.webfx.com/tools/emoji-cheat-sheet/">List of common emoji codes</a>'
              },
              {
                displayName: "Image URL",
                name: "icon_url",
