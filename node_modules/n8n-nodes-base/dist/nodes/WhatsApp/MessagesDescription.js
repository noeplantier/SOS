...
var MessagesDescription_exports = {};
__export(MessagesDescription_exports, {
  mediaTypes: () => mediaTypes,
  messageFields: () => messageFields,
  messageTypeFields: () => messageTypeFields
});
module.exports = __toCommonJS(MessagesDescription_exports);
...
const currencies = import_currency_codes.default.data.map(
  ({ code, currency }) => ({
    name: `${code} - ${currency}`,
    value: code
  })
...
const messageFields = [
  {
    ...
    routing: {
      ...
      send: {
        preSend: [import_MessageFunctions.setType]
      },
      output: { postReceive: [import_MessageFunctions.sendErrorPostReceive] }
    },
    displayOptions: {
      show: {
        resource: ["message"]
  ...
  },
  {
    ...
    routing: {
      send: {
        type: "body",
        preSend: [import_MessageFunctions.cleanPhoneNumber]
      }
    },
    displayOptions: {
      show: {
...
const messageTypeFields = [
  ...
  },
  {
    ...
    routing: {
      send: {
        preSend: [import_MessageFunctions.mediaUploadFromItem]
      }
    }
  },
  {
  ...
  // ----------------------------------
  {
    ...
    routing: {
      send: {
        ...
        preSend: [import_MessageFunctions.templateInfo]
      }
    }
  },
  //{
  ...
  //},
  {
    ...
    routing: {
      send: {
        preSend: [import_MessageFunctions.componentsRequest]
      }
    },
    options: [
      {
