...
__reExport(descriptions_exports, require("./OrganizationDescription"), module.exports);
...
__reExport(descriptions_exports, require("./WorkItemDescription"), module.exports);
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  ...require("./OrganizationDescription"),
  ...require("./SpaceDescription"),
  ...require("./UserDescription"),
  ...require("./WorkItemDescription")
});
