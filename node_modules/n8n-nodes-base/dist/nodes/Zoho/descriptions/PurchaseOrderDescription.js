...
var PurchaseOrderDescription_exports = {};
__export(PurchaseOrderDescription_exports, {
  purchaseOrderFields: () => purchaseOrderFields,
  purchaseOrderOperations: () => purchaseOrderOperations
});
module.exports = __toCommonJS(PurchaseOrderDescription_exports);
...
const purchaseOrderFields = [
  ...
  },
  {
    ...
    options: [
      ...
      (0, import_SharedFields.makeCustomFieldsFixedCollection)("purchaseOrder"),
      {
  ...
  // ----------------------------------------
  ...(0, import_SharedFields.makeGetAllFields)("purchaseOrder"),
  // ----------------------------------------
