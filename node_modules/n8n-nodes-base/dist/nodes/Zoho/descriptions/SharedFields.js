...
const makeGetAllFields = (resource) => {
  const loadOptionsMethod = `get${(0, import_GenericFunctions.capitalizeInitial)(resource)}Fields`;
  return [
    {
...
const makeCustomFieldsFixedCollection = (resource) => {
  const loadOptionsMethod = `getCustom${(0, import_GenericFunctions.capitalizeInitial)(resource)}Fields`;
  return {
