...
const contactFields = [
  ...
  },
  {
    ...
    options: [
      ...
      (0, import_SharedFields.makeCustomFieldsFixedCollection)("contact"),
      {
      ...
      import_SharedFields.mailingAddress,
      {
        displayName: "Mobile",
        name: "Mobile",
        type: "string",
      ...
      import_SharedFields.otherAddress,
      {
        displayName: "Phone",
        name: "Phone",
        type: "string",
  ...
  //             contact: getAll
  // ----------------------------------------
  ...(0, import_SharedFields.makeGetAllFields)("contact"),
  // ----------------------------------------
  //             contact: update
  // ----------------------------------------
  {
