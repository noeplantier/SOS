...
var TriggerDescription_exports = {};
__export(TriggerDescription_exports, {
  fileRLC: () => fileRLC,
  folderRLC: () => folderRLC,
  triggerDescription: () => triggerDescription
});
module.exports = __toCommonJS(TriggerDescription_exports);
  ...
  modes: [
    {
      ...
      extractValue: {
        type: "regex",
        regex: import_constants.MICROSOFT_DRIVE_FILE_URL_REGEX
      },
      validation: [
        {
          type: "regex",
  ...
  modes: [
    {
      ...
      extractValue: {
        type: "regex",
        regex: import_constants.MICROSOFT_DRIVE_FOLDER_URL_REGEX
      },
      validation: [
        {
          type: "regex",
