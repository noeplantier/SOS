...
var BlobDescription_exports = {};
__export(BlobDescription_exports, {
  blobFields: () => blobFields,
  blobOperations: () => blobOperations
});
module.exports = __toCommonJS(BlobDescription_exports);
    ...
    options: [
      {
        ...
        routing: {
          request: {
            ...
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_DATE]: "={{ new Date().toUTCString() }}",
              [import_GenericFunctions.HeaderConstants.X_MS_VERSION]: import_GenericFunctions.XMsVersion
            }
          },
          output: {
            postReceive: [
              import_GenericFunctions.handleErrorPostReceive,
              async function(_data, response) {
                return [
                  {
                    json: (0, import_GenericFunctions.parseHeaders)(response.headers)
                  }
                ];
              }
            ]
        ...
        routing: {
          ...
          output: {
            postReceive: [
              import_GenericFunctions.handleErrorPostReceive,
              async function(_data, response) {
                const headerData = (0, import_GenericFunctions.parseHeaders)(response.headers);
                const simplify = this.getNodeParameter("options.simplify", true);
                if (simplify) {
                ...
                const newItem = {
                  json: {
                    name: this.getNodeParameter("blob").value,
                    properties,
                    ...metadata ? { metadata } : {}
                  },
                  binary: {}
      ...
      },
      {
        ...
        routing: {
          ...
          output: {
            postReceive: [
              import_GenericFunctions.handleErrorPostReceive,
              async function(data, _response) {
                const bodyData = await (0, import_GenericFunctions.parseBlobList)(data[0].json);
      ...
      send: {
        preSend: [
          async function(requestOptions) {
            ...
            requestOptions.headers[import_GenericFunctions.HeaderConstants.CONTENT_LENGTH] = binaryDataBuffer.length;
            requestOptions.headers[import_GenericFunctions.HeaderConstants.X_MS_BLOB_TYPE] = "BlockBlob";
            if (binaryData.mimeType) {
              requestOptions.headers[import_GenericFunctions.HeaderConstants.CONTENT_TYPE] = binaryData.mimeType;
            }
            if (binaryData.fileName) {
              requestOptions.headers[import_GenericFunctions.HeaderConstants.X_MS_BLOB_CONTENT_DISPOSITION] = `attachment; filename="${binaryData.fileName}"`;
            }
      ...
      send: {
        preSend: [
          async function(requestOptions) {
            ...
            requestOptions.headers ??= {};
            requestOptions.headers[import_GenericFunctions.HeaderConstants.X_MS_BLOB_TYPE] = "BlockBlob";
            requestOptions.headers[import_GenericFunctions.HeaderConstants.X_MS_COPY_SOURCE] = url;
            return requestOptions;
          }
        ]
      }
    ...
    options: [
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_ACCESS_TIER]: "={{ $value || undefined }}"
            }
          }
        },
        type: "options",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_BLOB_TYPE]: "={{ $value || undefined }}"
            }
          }
        },
        type: "options",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_BLOB_CACHE_CONTROL]: "={{ $value || undefined }}"
            }
          }
        },
        type: "string",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_CONTENT_CRC64]: "={{ $value || undefined }}"
            }
          }
        },
        type: "string",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_BLOB_CONTENT_ENCODING]: "={{ $value || undefined }}"
            }
          }
        },
        type: "string",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_BLOB_CONTENT_LANGUAGE]: "={{ $value || undefined }}"
            }
          }
        },
        type: "string",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_BLOB_CONTENT_MD5]: "={{ $value || undefined }}"
            }
          }
        },
        type: "string",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_BLOB_CONTENT_TYPE]: "={{ $value || undefined }}"
            }
          }
        },
        type: "string",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_ENCRYPTION_CONTEXT]: "={{ $value || undefined }}"
            }
          }
        },
        type: "string",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_ENCRYPTION_SCOPE]: "={{ $value || undefined }}"
            }
          }
        },
        type: "string",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_EXPIRY_OPTION]: "={{ $value || undefined }}"
            }
          }
        },
        type: "options",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_EXPIRY_TIME]: '={{ $value ? DateTime.fromISO($value).format("EEE, dd MMM yyyy HH:mm:ss ZZZ") : undefined }}'
            }
          }
        },
        type: "dateTime",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_BLOB_CONTENT_DISPOSITION]: `={{ $value ? 'attachment; filename="' + $value + '"' : undefined }}`
            }
          }
        },
        type: "string",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_IMMUTABILITY_POLICY_UNTIL_DATE]: '={{ $value ? DateTime.fromISO($value).format("EEE, dd MMM yyyy HH:mm:ss ZZZ") : undefined }}'
            }
          }
        },
        type: "dateTime",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_IMMUTABILITY_POLICY_MODE]: "={{ $value || undefined }}"
            }
          }
        },
        type: "string",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_LEASE_ID]: "={{ $value || undefined }}"
            }
          }
        },
        type: "string",
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_LEGAL_HOLD]: "={{ $value?.toString() || undefined }}"
            }
          }
        },
        type: "boolean",
        ...
        routing: {
          send: {
            preSend: [
              async function(requestOptions) {
                requestOptions.headers ??= {};
                const metadata = this.getNodeParameter("options.metadata");
                for (const data of metadata.metadataValues) {
                  requestOptions.headers[`${import_GenericFunctions.HeaderConstants.PREFIX_X_MS_META}${data.fieldName}`] = data.fieldValue;
                }
                return requestOptions;
              }
            ]
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.ORIGIN]: "={{ $value || undefined }}"
            }
          }
        },
        type: "string",
        ...
        routing: {
          send: {
            preSend: [
              async function(requestOptions) {
                requestOptions.headers ??= {};
                const tags = this.getNodeParameter("options.tags");
                requestOptions.headers[import_GenericFunctions.HeaderConstants.X_MS_TAGS] = tags.tagValues.map(
                  (tag) => `${encodeURIComponent(tag.tagName)}=${encodeURIComponent(tag.tagValue)}`
                ).join("&");
                return requestOptions;
              }
            ]
    ...
    options: [
      ...
      },
      {
        ...
        routing: {
          request: {
            headers: {
              [import_GenericFunctions.HeaderConstants.X_MS_UPN]: "={{ $value?.toString() || undefined }}"
            }
          }
        },
        type: "boolean",
      ...
      operations: {
        async pagination(requestOptions) {
          ...
          do {
            ...
            marker = responseData[0].json.nextMarker;
            executions = executions.concat(
              responseData[0].json.blobs.map((item) => ({ json: item }))
            );
          } while (marker);
          return executions;
        }
  ...
  },
  {
    ...
    routing: {
      ...
      output: {
        postReceive: [
          async function(data, _response) {
            return data[0].json.blobs.map((item) => ({ json: item }));
          }
        ]
      }
    },
