...
__export(mocks_exports, {
  microsoftEntraApiResponse: () => microsoftEntraApiResponse,
  microsoftEntraNodeResponse: () => microsoftEntraNodeResponse
});
module.exports = __toCommonJS(mocks_exports);
const microsoftEntraApiResponse = {
  postGroup: {
...
const microsoftEntraNodeResponse = {
  createGroup: [
    {
      json: {
        "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#groups/$entity",
