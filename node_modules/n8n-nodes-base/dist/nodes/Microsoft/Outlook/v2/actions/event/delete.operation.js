...
const properties = [import_descriptions.calendarRLC, import_descriptions.eventRLC];
...
async function execute(index) {
  ...
  await import_transport.microsoftApiRequest.call(this, "DELETE", `/calendar/events/${eventId}`);
