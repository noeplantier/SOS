...
async function execute(index) {
  ...
  const displayName = this.getNodeParameter("displayName", index, void 0);
  const responseData = await import_transport.microsoftApiRequest.call(this, "PATCH", `/mailFolders/${folderId}`, {
    displayName
  });
