...
__export(description_exports, {
  ...
  responseCodeOption: () => responseCodeOption,
  responseCodeProperty: () => responseCodeProperty,
  responseCodeSelector: () => responseCodeSelector,
...
const defaultWebhookDescription = {
  ...
  isFullPath: true,
  responseCode: `={{(${import_utils.getResponseCode})($parameter)}}`,
  responseMode: '={{$parameter["responseMode"]}}',
  responseData: `={{(${import_utils.getResponseData})($parameter)}}`,
...
const responseBinaryPropertyNameProperty = {
