...
var Dropcontact_node_exports = {};
__export(Dropcontact_node_exports, {
  Dropcontact: () => Dropcontact
});
module.exports = __toCommonJS(Dropcontact_node_exports);
  ...
  async execute() {
    ...
    if (resource === "contact") {
      if (operation === "enrich") {
        ...
        responseData = await import_GenericFunction.dropcontactApiRequest.call(
          this,
          "POST",
          "/batch",
          { data, siren, language },
        ...
        if (!responseData.success) {
          if (this.continueOnFail()) {
            const executionData = this.helpers.constructExecutionMetaData(
              ...
              {
                itemData: (0, import_GenericFunction.mapPairedItemsFrom)(entryData)
              }
            );
        ...
        if (!simplify) {
          ...
          const delay = async (ms) => await new Promise((res) => setTimeout(res, ms * 1e3));
