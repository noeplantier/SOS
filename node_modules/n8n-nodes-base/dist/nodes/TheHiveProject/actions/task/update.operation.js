...
async function execute(i, item) {
  ...
  if (fieldsToMatchOn.includes("id")) {
    await import_transport.theHiveApiRequest.call(this, "PATCH", `/v1/task/${id}`, body);
  } else {
    const filter = {
      _name: "filter",
    ...
    updated = ids.length;
    updateBody.ids = ids;
    await import_transport.theHiveApiRequest.call(this, "PATCH", "/v1/task/_bulk", updateBody);
  }
