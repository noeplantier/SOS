...
var deleteObservable_operation_exports = {};
__export(deleteObservable_operation_exports, {
  description: () => description,
  execute: () => execute
});
module.exports = __toCommonJS(deleteObservable_operation_exports);
...
async function execute(i) {
  ...
  await import_transport.theHiveApiRequest.call(this, "DELETE", `/v1/observable/${observableId}`);
