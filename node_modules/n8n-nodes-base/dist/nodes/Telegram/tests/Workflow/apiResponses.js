...
__export(apiResponses_exports, {
  chatAdministratorsResponse: () => chatAdministratorsResponse,
  editMessageTextResponse: () => editMessageTextResponse,
  getChatResponse: () => getChatResponse,
  getMemberResponse: () => getMemberResponse,
  okTrueResponse: () => okTrueResponse,
  sendAnimationMessageResponse: () => sendAnimationMessageResponse,
  sendAudioResponse: () => sendAudioResponse,
  sendLocationMessageResponse: () => sendLocationMessageResponse,
  sendMediaGroupResponse: () => sendMediaGroupResponse,
  sendMessageResponse: () => sendMessageResponse,
  sendStickerResponse: () => sendStickerResponse
});
...
const sendLocationMessageResponse = {
  ok: true,
  result: {
    message_id: 42,
    from: {
...
const okTrueResponse = {
  ok: true,
  result: true
};
const sendStickerResponse = {
  ok: true,
  result: {
    message_id: 44,
    from: {
...
const chatAdministratorsResponse = {
  ok: true,
  result: [
    {
      user: {
...
const sendAnimationMessageResponse = {
  ok: true,
  result: {
    message_id: 45,
    from: {
