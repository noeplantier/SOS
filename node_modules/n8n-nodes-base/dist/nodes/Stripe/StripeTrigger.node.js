...
var StripeTrigger_node_exports = {};
__export(StripeTrigger_node_exports, {
  StripeTrigger: () => StripeTrigger
});
module.exports = __toCommonJS(StripeTrigger_node_exports);
    ...
    this.webhookMethods = {
      default: {
        async checkExists() {
          ...
          try {
            await import_helpers.stripeApiRequest.call(this, "GET", endpoint, {});
          } catch (error) {
        ...
        async create() {
          ...
          const responseData = await import_helpers.stripeApiRequest.call(this, "POST", endpoint, body);
          if (responseData.id === void 0 || responseData.secret === void 0 || responseData.status !== "enabled") {
        ...
        async delete() {
          ...
          if (webhookData.webhookId !== void 0) {
            ...
            const body = {};
            try {
              await import_helpers.stripeApiRequest.call(this, "DELETE", endpoint, body);
            } catch (error) {
              return false;
            }
            delete webhookData.webhookId;
