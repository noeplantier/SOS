...
var SwitchV2_node_exports = {};
__export(SwitchV2_node_exports, {
  SwitchV2: () => SwitchV2
});
module.exports = __toCommonJS(SwitchV2_node_exports);
						...
						if (mode === 'expression') {
							return Array
								.from(
									...
									(_, i) => ({ type: "${import_n8n_workflow.NodeConnectionTypes.Main}", displayName: i.toString() })
								)
						}


						return rules.map(value => {
							return { type: "${import_n8n_workflow.NodeConnectionTypes.Main}", displayName: value.outputKey }
						})
					})($parameter)
				}}`,
      properties: [
