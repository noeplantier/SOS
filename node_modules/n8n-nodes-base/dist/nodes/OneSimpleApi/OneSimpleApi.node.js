...
var OneSimpleApi_node_exports = {};
__export(OneSimpleApi_node_exports, {
  OneSimpleApi: () => OneSimpleApi
});
module.exports = __toCommonJS(OneSimpleApi_node_exports);
      ...
      try {
        ...
        if (resource === "website") {
          if (operation === "pdf") {
            ...
            const response = await import_GenericFunctions.oneSimpleApiRequest.call(this, "GET", "/pdf", {}, qs);
            if (download) {
              const output = this.getNodeParameter("output", i);
              const buffer = await import_GenericFunctions.oneSimpleApiRequest.call(
                this,
                "GET",
                "",
                {},
          ...
          if (operation === "screenshot") {
            ...
            const response = await import_GenericFunctions.oneSimpleApiRequest.call(this, "GET", "/screenshot", {}, qs);
            if (download) {
              const output = this.getNodeParameter("output", i);
              const buffer = await import_GenericFunctions.oneSimpleApiRequest.call(
                this,
          ...
          if (operation === "seo") {
            ...
            responseData = await import_GenericFunctions.oneSimpleApiRequest.call(this, "GET", "/page_info", {}, qs);
          }
        }
        if (resource === "socialProfile") {
          if (operation === "instagramProfile") {
            ...
            responseData = await import_GenericFunctions.oneSimpleApiRequest.call(
              this,
              "GET",
              "/instagram_profile",
              {},
          ...
          if (operation === "spotifyArtistProfile") {
            ...
            responseData = await import_GenericFunctions.oneSimpleApiRequest.call(this, "GET", "/spotify_profile", {}, qs);
          }
        }
        if (resource === "information") {
          if (operation === "exchangeRate") {
            ...
            qs.from_value = value;
            responseData = await import_GenericFunctions.oneSimpleApiRequest.call(this, "GET", "/exchange_rate", {}, qs);
          }
          if (operation === "imageMetadata") {
            const link = this.getNodeParameter("link", i);
            qs.url = link;
            qs.raw = true;
            responseData = await import_GenericFunctions.oneSimpleApiRequest.call(this, "GET", "/image_info", {}, qs);
          }
        }
        if (resource === "utility") {
          if (operation === "validateEmail") {
            ...
            responseData = await import_GenericFunctions.oneSimpleApiRequest.call(this, "GET", "/email", {}, qs);
          }
          if (operation === "expandURL") {
            const url = this.getNodeParameter("link", i);
            qs.url = url;
            responseData = await import_GenericFunctions.oneSimpleApiRequest.call(this, "GET", "/unshorten", {}, qs);
          }
          if (operation === "qrCode") {
            ...
            const response = await import_GenericFunctions.oneSimpleApiRequest.call(this, "GET", "/qr_code", {}, qs);
            if (download) {
              const output = this.getNodeParameter("output", i);
              const buffer = await import_GenericFunctions.oneSimpleApiRequest.call(
                this,
