...
var GithubTrigger_node_exports = {};
__export(GithubTrigger_node_exports, {
  GithubTrigger: () => GithubTrigger
});
module.exports = __toCommonJS(GithubTrigger_node_exports);
...
class GithubTrigger {
    ...
    this.webhookMethods = {
      default: {
        async checkExists() {
          ...
          try {
            await import_GenericFunctions.githubApiRequest.call(this, "GET", endpoint, {});
          } catch (error) {
        ...
        async create() {
          ...
          try {
            ...
            if (error.cause.httpCode === "422") {
              responseData = await import_GenericFunctions.githubApiRequest.call(this, "GET", endpoint, body);
          ...
          if (responseData.id === void 0 || responseData.active !== true) {
        ...
        async delete() {
          ...
          if (webhookData.webhookId !== void 0) {
            ...
            const body = {};
            try {
              await import_GenericFunctions.githubApiRequest.call(this, "DELETE", endpoint, body);
            } catch (error) {
              return false;
            }
            delete webhookData.webhookId;
  ...
  async webhook() {
    ...
    if (bodyData.hook_id !== void 0 && bodyData.action === void 0) {
      return {
        webhookResponse: "OK"
      };
    }
