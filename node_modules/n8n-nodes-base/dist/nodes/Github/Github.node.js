...
var Github_node_exports = {};
__export(Github_node_exports, {
  Github: () => Github
});
module.exports = __toCommonJS(Github_node_exports);
...
class Github {
  constructor() {
    ...
    this.methods = {
      listSearch: {
        getRefs: import_SearchFunctions.getRefs,
        getRepositories: import_SearchFunctions.getRepositories,
        getUsers: import_SearchFunctions.getUsers,
        getWorkflows: import_SearchFunctions.getWorkflows
      }
    };
  }
  async webhook() {
  ...
  async execute() {
    ...
    if (resource === "workflow" && operation === "dispatchAndWait") {
      ...
      const inputs = (0, import_GenericFunctions.validateJSON)(this.getNodeParameter("inputs", 0));
      if (!inputs) {
        throw new import_n8n_workflow.NodeOperationError(this.getNode(), "Inputs: Invalid JSON");
      }
      ...
      try {
        responseData = await import_GenericFunctions.githubApiRequest.call(this, "POST", endpoint, body);
      } catch (error) {
      ...
      await this.putExecutionToWait(import_n8n_workflow.WAIT_INDEFINITELY);
      ...
      try {
        ...
        if (resource === "file") {
          if (["create", "edit"].includes(operation)) {
            ...
            if (operation === "edit") {
              body.sha = await import_GenericFunctions.getFileSha.call(
                this,
                owner,
                repository,
                filePath,
            ...
            if (this.getNodeParameter("binaryData", i)) {
              ...
              if ((0, import_GenericFunctions.isBase64)(fileContent)) {
          ...
          if (operation === "get") {
            ...
            body.event = (0, import_change_case.snakeCase)(this.getNodeParameter("event", i)).toUpperCase();
          ...
          if (operation === "dispatch") {
            ...
            body.ref = ref;
            const inputs = (0, import_GenericFunctions.validateJSON)(
              this.getNodeParameter("inputs", i)
            );
            if (inputs === void 0) {
              throw new import_n8n_workflow.NodeOperationError(this.getNode(), "Inputs: Invalid JSON", {
                itemIndex: i
        ...
        if (returnAll) {
          responseData = await import_GenericFunctions.githubApiRequestAllItems.call(
            this,
            requestMethod,
            endpoint,
            body,
          ...
          responseData = await import_GenericFunctions.githubApiRequest.call(this, requestMethod, endpoint, body, qs);
        }
