...
var ObservableDescription_exports = {};
__export(ObservableDescription_exports, {
  observableFields: () => observableFields,
  observableOperations: () => observableOperations
});
module.exports = __toCommonJS(ObservableDescription_exports);
var import_AlertInterface = require("../interfaces/AlertInterface");
...
const observableFields = [
  ...
  },
  {
    ...
    options: [
      {
        name: "White",
        value: import_AlertInterface.TLPs.white
      },
      {
        name: "Green",
        value: import_AlertInterface.TLPs.green
      },
      {
        name: "Amber",
        value: import_AlertInterface.TLPs.amber
      },
      {
        name: "Red",
        value: import_AlertInterface.TLPs.red
      }
    ],
    ...
    options: [
      {
        ...
        name: "sort",
        type: "string",
        placeholder: "\xB1Attribut, exp +status",
