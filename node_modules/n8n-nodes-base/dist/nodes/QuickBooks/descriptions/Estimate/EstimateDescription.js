...
var EstimateDescription_exports = {};
__export(EstimateDescription_exports, {
  estimateFields: () => estimateFields,
  estimateOperations: () => estimateOperations
});
module.exports = __toCommonJS(EstimateDescription_exports);
var import_EstimateAdditionalFieldsOptions = require("./EstimateAdditionalFieldsOptions");
...
const estimateFields = [
  ...
  },
  {
    ...
    options: import_EstimateAdditionalFieldsOptions.estimateAdditionalFieldsOptions
  },
  // ----------------------------------
  //         estimate: delete
  // ----------------------------------
  ...
  },
  {
    ...
    options: import_EstimateAdditionalFieldsOptions.estimateAdditionalFieldsOptions.filter(
