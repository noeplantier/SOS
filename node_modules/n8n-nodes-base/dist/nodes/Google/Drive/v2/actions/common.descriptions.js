...
__export(common_descriptions_exports, {
  ...
  folderNoRootRLC: () => folderNoRootRLC,
  folderRLC: () => folderRLC,
  permissionsOptions: () => permissionsOptions,
  shareOptions: () => shareOptions,
  sharedDriveRLC: () => sharedDriveRLC,
  updateCommonOptions: () => updateCommonOptions
});
...
const driveRLC = {
  ...
  name: "driveId",
  type: "resourceLocator",
  default: { mode: "list", value: import_interfaces.RLC_DRIVE_DEFAULT },
  required: true,
  modes: [
    {
      displayName: "Drive",
...
const fileTypesOptions = [
  ...
  },
  {
    ...
    value: import_interfaces.DRIVE.SDK
  },
  {
    name: "Audio",
    value: import_interfaces.DRIVE.AUDIO
  },
  {
    name: "Folder",
    value: import_interfaces.DRIVE.FOLDER
  },
  {
    name: "Google Apps Scripts",
    value: import_interfaces.DRIVE.APP_SCRIPTS
  },
  {
    name: "Google Docs",
    value: import_interfaces.DRIVE.DOCUMENT
  },
  {
    name: "Google Drawing",
    value: import_interfaces.DRIVE.DRAWING
  },
  {
    name: "Google Forms",
    value: import_interfaces.DRIVE.FORM
  },
  {
    name: "Google Fusion Tables",
    value: import_interfaces.DRIVE.FUSIONTABLE
  },
  {
    name: "Google My Maps",
    value: import_interfaces.DRIVE.MAP
  },
  {
    name: "Google Sheets",
    value: import_interfaces.DRIVE.SPREADSHEET
  },
  {
    name: "Google Sites",
    value: import_interfaces.DRIVE.SITES
  },
  {
    name: "Google Slides",
    value: import_interfaces.DRIVE.PRESENTATION
  },
  {
    name: "Photo",
    value: import_interfaces.DRIVE.PHOTO
  },
  {
    name: "Unknown",
    value: import_interfaces.DRIVE.UNKNOWN
  },
  {
    name: "Video",
    value: import_interfaces.DRIVE.VIDEO
  }
];
