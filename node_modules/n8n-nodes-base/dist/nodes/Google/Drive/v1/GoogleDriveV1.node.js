...
var GoogleDriveV1_node_exports = {};
__export(GoogleDriveV1_node_exports, {
  GoogleDriveV1: () => GoogleDriveV1
});
module.exports = __toCommonJS(GoogleDriveV1_node_exports);
...
class GoogleDriveV1 {
  constructor(baseDescription) {
    this.methods = {
      listSearch: {
        fileSearch: import_SearchFunctions.fileSearch,
        folderSearch: import_SearchFunctions.folderSearch,
        driveSearch: import_SearchFunctions.driveSearch
      }
    };
    this.description = {
      ...baseDescription,
      ...
      try {
        ...
        if (resource === "drive") {
          if (operation === "create") {
            ...
            const response = await import_GenericFunctions.googleApiRequest.call(this, "POST", "/drive/v3/drives", body, {
          ...
          if (operation === "delete") {
            ...
            await import_GenericFunctions.googleApiRequest.call(this, "DELETE", `/drive/v3/drives/${driveId}`);
            const executionData = this.helpers.constructExecutionMetaData(
          ...
          if (operation === "list") {
            ...
            Object.assign(qs, options);
            if (returnAll) {
              response = await import_GenericFunctions.googleApiRequestAllItems.call(
                this,
                "drives",
                "GET",
                "/drive/v3/drives",
              ...
              const data = await import_GenericFunctions.googleApiRequest.call(this, "GET", "/drive/v3/drives", {}, qs);
        ...
        if (resource === "file") {
          if (operation === "copy") {
            ...
            for (const propertyName of optionProperties) {
              if (options[propertyName] !== void 0) {
            ...
            const file = await import_GenericFunctions.googleApiRequest.call(
              this,
              "GET",
            ...
            if (file.mimeType.includes("vnd.google-apps")) {
              ...
              response = await import_GenericFunctions.googleApiRequest.call(
                this,
                "GET",
            ...
            const response = await import_GenericFunctions.googleApiRequest.call(this, "GET", "/drive/v3/files", {}, qs);
            ...
            if (Buffer.isBuffer(fileContent)) {
              const response2 = await import_GenericFunctions.googleApiRequest.call(
                this,
                "POST",
              ...
              uploadId = JSON.parse(response2).id;
            } else {
            ...
            let response = await import_GenericFunctions.googleApiRequest.call(
              this,
              "PATCH",
            ...
            const id = this.getNodeParameter("fileId", i, void 0, {
              extractValue: true
            });
        ...
        if (resource === "folder") {
          if (operation === "create") {
            ...
            const response = await import_GenericFunctions.googleApiRequest.call(this, "POST", "/drive/v3/files", body, qs);
            const executionData = this.helpers.constructExecutionMetaData(
              this.helpers.returnJsonArray(response),
              { itemData: { item: i } }
            );
