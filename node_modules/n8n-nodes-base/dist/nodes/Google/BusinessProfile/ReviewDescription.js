...
var ReviewDescription_exports = {};
__export(ReviewDescription_exports, {
  reviewFields: () => reviewFields,
  reviewOperations: () => reviewOperations
});
module.exports = __toCommonJS(ReviewDescription_exports);
    ...
    options: [
      {
        ...
        routing: {
          ...
          output: {
            postReceive: [import_GenericFunctions.handleErrorsDeleteReply]
          }
        }
      },
      {
        ...
        routing: {
          ...
          output: {
            postReceive: [import_GenericFunctions.handleErrorsGetReview]
          }
        }
      },
      {
      ...
      },
      {
        ...
        routing: {
          ...
          output: {
            postReceive: [import_GenericFunctions.handleErrorsReplyToReview]
          }
        }
      }
    ]
...
//# sourceMappingURL=ReviewDescription.js.map