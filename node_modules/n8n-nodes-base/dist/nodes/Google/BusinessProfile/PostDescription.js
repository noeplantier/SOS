    ...
    options: [
      {
        ...
        routing: {
          send: { preSend: [import_GenericFunctions.handleDatesPresend] },
          request: {
            method: "POST",
      ...
      },
      {
        ...
        routing: {
          ...
          output: {
            postReceive: [import_GenericFunctions.handleErrorsDeletePost]
          }
        }
      },
      {
        ...
        routing: {
          ...
          output: {
            postReceive: [import_GenericFunctions.handleErrorsGetPost]
          }
        }
      },
      {
        ...
        routing: {
          ...
          request: {
            ...
            qs: {
              ...
              // Google allows maximum 100 results per page
            }
          }
        }
      },
      {
        ...
        routing: {
          send: {
            preSend: [import_GenericFunctions.handleDatesPresend, import_GenericFunctions.addUpdateMaskPresend]
          },
          request: {
            method: "PATCH",
            url: '=/{{$parameter["post"]}}',
          ...
          output: {
            postReceive: [import_GenericFunctions.handleErrorsUpdatePost]
          }
        }
      }
    ]
