...
var appendOrUpdate_operation_exports = {};
__export(appendOrUpdate_operation_exports, {
  description: () => description,
  execute: () => execute
});
module.exports = __toCommonJS(appendOrUpdate_operation_exports);
...
async function execute(sheet, sheetName, sheetId) {
  ...
  if (nodeVersion >= 4.4) {
    ...
    (0, import_GoogleSheets2.checkForSchemaChanges)(this.getNode(), columnNames, schema);
  }
