...
var BucketDescription_exports = {};
__export(BucketDescription_exports, {
  bucketFields: () => bucketFields,
  bucketOperations: () => bucketOperations
});
module.exports = __toCommonJS(BucketDescription_exports);
const PAGE_LIMITS = {
  noAcl: 1e3,
  full: 200
};
            ...
            preSend: [
              async function(requestOptions) {
                ...
                if (!returnAll) {
                  ...
                  requestOptions.qs.maxResults = key === "noAcl" ? PAGE_LIMITS.noAcl : PAGE_LIMITS.full;
                }
                return requestOptions;
              }
            ]
