...
var ObjectDescription_exports = {};
__export(ObjectDescription_exports, {
  objectFields: () => objectFields,
  objectOperations: () => objectOperations
});
module.exports = __toCommonJS(ObjectDescription_exports);
              ...
              async function(requestOptions) {
                ...
                if (useBinary) {
                  ...
                  if (binaryData.id) {
                    ...
                    content = Buffer.from(binaryData.data, import_n8n_workflow.BINARY_ENCODING);
