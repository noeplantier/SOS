...
var GoogleBooks_node_exports = {};
__export(GoogleBooks_node_exports, {
  GoogleBooks: () => GoogleBooks
});
module.exports = __toCommonJS(GoogleBooks_node_exports);
      ...
      try {
        if (resource === "volume") {
          if (operation === "get") {
            ...
            responseData = await import_GenericFunctions.googleApiRequest.call(this, "GET", `v1/volumes/${volumeId}`, {});
