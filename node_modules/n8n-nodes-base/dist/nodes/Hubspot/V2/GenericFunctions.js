...
__export(GenericFunctions_exports, {
  ...
  getCallMetadata: () => getCallMetadata,
  getEmailMetadata: () => getEmailMetadata,
  getMeetingMetadata: () => getMeetingMetadata,
...
function clean(obj) {
  for (const propName in obj) {
    if (obj[propName] === null || obj[propName] === void 0 || obj[propName] === "") {
      delete obj[propName];
    }
  }
  return obj;
...
const getMeetingMetadata = (meta) => {
  return {
    ...meta.body && { body: meta.body },
    ...meta.startTime && { startTime: (0, import_moment_timezone.default)(meta.startTime).unix() },
    ...meta.endTime && { endTime: (0, import_moment_timezone.default)(meta.endTime).unix() },
