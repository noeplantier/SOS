...
var Vonage_node_exports = {};
__export(Vonage_node_exports, {
  Vonage: () => Vonage
});
module.exports = __toCommonJS(Vonage_node_exports);
      ...
      try {
        if (resource === "sms") {
          if (operation === "send") {
            ...
            if (body.ttl) {
              body.ttl = body.ttl * 6e4;
            }
            responseData = await import_GenericFunctions.vonageApiRequest.call(this, "POST", "/sms/json", body);
