...
var ConnectionDescription_exports = {};
__export(ConnectionDescription_exports, {
  connectionFields: () => connectionFields,
  connectionOperations: () => connectionOperations
});
module.exports = __toCommonJS(ConnectionDescription_exports);
...
const connectionFields = [
  ...
  //         connection:getAll
  // ----------------------------------
  ...(0, import_GenericFunctions.activeCampaignDefaultGetAllProperties)("connection", "getAll")
];
