...
var Pipedrive_node_exports = {};
__export(Pipedrive_node_exports, {
  Pipedrive: () => Pipedrive
});
module.exports = __toCommonJS(Pipedrive_node_exports);
              ...
              options: [
                {
                  ...
                  values: [
                    ...
                    },
                    {
                      ...
                      type: "options",
                      default: "USD",
                      options: import_utils.currencies.sort((a, b) => a.name.localeCompare(b.name))
                    }
                  ]
                }
              ]
    ...
    this.methods = {
      loadOptions: {
        ...
        async getActivityTypes() {
          const returnData = [];
          const { data } = await import_GenericFunctions.pipedriveApiRequest.call(this, "GET", "/activityTypes", {});
        ...
        async getFilters() {
          ...
          const { data } = await import_GenericFunctions.pipedriveApiRequest.call(
            this,
            "GET",
            "/filters",
            {},
        ...
        async getOrganizationIds() {
          const returnData = [];
          const { data } = await import_GenericFunctions.pipedriveApiRequest.call(this, "GET", "/organizations", {});
        ...
        async getUserIds() {
          ...
          const { data } = await import_GenericFunctions.pipedriveApiRequest.call(this, "GET", "/users", {});
        ...
        // select them easily
        async getDeals() {
          const { data } = await import_GenericFunctions.pipedriveApiRequest.call(this, "GET", "/deals", {});
          return (0, import_GenericFunctions.sortOptionParameters)(data.map(({ id, title }) => ({ value: id, name: title })));
        },
        // Get all Products to display them to user so that they can
        // select them easily
        async getProducts() {
          const { data } = await import_GenericFunctions.pipedriveApiRequest.call(this, "GET", "/products", {});
          return (0, import_GenericFunctions.sortOptionParameters)(data.map(({ id, name }) => ({ value: id, name })));
        },
        ...
        async getStageIds() {
          const returnData = [];
          const { data } = await import_GenericFunctions.pipedriveApiRequest.call(this, "GET", "/stages", {});
        ...
        async getOrganizationCustomFields() {
          const returnData = [];
          const { data } = await import_GenericFunctions.pipedriveApiRequest.call(this, "GET", "/organizationFields", {});
        ...
        async getDealCustomFields() {
          const returnData = [];
          const { data } = await import_GenericFunctions.pipedriveApiRequest.call(this, "GET", "/dealFields", {});
          for (const field of data) {
            if (field.key.length === 40) {
              returnData.push({
                name: field.name,
        ...
        async getPersonCustomFields() {
          const returnData = [];
          const { data } = await import_GenericFunctions.pipedriveApiRequest.call(this, "GET", "/personFields", {});
          for (const field of data) {
            if (field.key.length === 40) {
              returnData.push({
                name: field.name,
        ...
        async getPersonLabels() {
          ...
          (0, import_GenericFunctions.sortOptionParameters)(returnData);
          if (operation === "update") {
            returnData.push({
              name: "No Label",
              value: "null"
        ...
        // select them easily
        async getPersons() {
          const { data } = await import_GenericFunctions.pipedriveApiRequest.call(this, "GET", "/persons", {});
          return (0, import_GenericFunctions.sortOptionParameters)(data.map(({ id, name }) => ({ value: id, name })));
        },
        // Get all the lead labels to display them to user so that they can
        // select them easily
        async getLeadLabels() {
          const { data } = await import_GenericFunctions.pipedriveApiRequest.call(this, "GET", "/leadLabels", {});
          return (0, import_GenericFunctions.sortOptionParameters)(data.map(({ id, name }) => ({ value: id, name })));
        },
        // Get all the labels to display them to user so that they can
        // select them easily
  ...
  async execute() {
    ...
    if (["get", "getAll", "update"].includes(operation) && ["activity", "deal", "organization", "person", "product"].includes(resource)) {
      ...
      if (getCustomProperties) {
        customProperties = await import_GenericFunctions.pipedriveGetCustomProperties.call(this, resource);
      }
    }
      ...
      try {
        if (resource === "activity") {
          ...
          if (operation === "getAll") {
            ...
            if (additionalFields?.done !== void 0) {
        ...
        let responseData;
        if (returnAll) {
          responseData = await import_GenericFunctions.pipedriveApiRequestAllItems.call(
            this,
            requestMethod,
            endpoint,
            body,
          ...
          if (customProperties !== void 0) {
            (0, import_GenericFunctions.pipedriveEncodeCustomProperties)(customProperties, body);
          }
          responseData = await import_GenericFunctions.pipedriveApiRequest.call(
            this,
            requestMethod,
            endpoint,
            body,
    ...
    if (customProperties !== void 0) {
      for (const item of returnData) {
        (0, import_GenericFunctions.pipedriveResolveCustomProperties)(customProperties, item);
      }
    }
    if (resource === "file" && operation === "download") {
      return [items];
