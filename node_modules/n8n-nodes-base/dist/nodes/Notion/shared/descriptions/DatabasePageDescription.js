...
var DatabasePageDescription_exports = {};
__export(DatabasePageDescription_exports, {
  databasePageFields: () => databasePageFields,
  databasePageOperations: () => databasePageOperations
});
module.exports = __toCommonJS(DatabasePageDescription_exports);
var import_Blocks = require("./Blocks");
var import_Filters = require("./Filters");
var import_constants = require("../constants");
var import_GenericFunctions = require("../GenericFunctions");
const databasePageOperations = [
  {
...
const databasePageFields = [
  ...
  ...(0, import_Blocks.blocks)("databasePage", "create"),
  {
    displayName: "Options",
    name: "options",
    type: "collection",
    ...
    modes: [
      {
        ...
        validation: [
          {
            type: "regex",
            properties: {
              regex: import_constants.databasePageUrlValidationRegexp,
        ...
        extractValue: {
          type: "regex",
          regex: import_constants.databasePageUrlExtractionRegexp
        }
      },
      {
        displayName: "ID",
  ...
  ...(0, import_GenericFunctions.getSearchFilters)("databasePage"),
  {
    displayName: "Options",
    name: "options",
    type: "collection",
        ...
        options: [
          {
            ...
            values: [...(0, import_Filters.filters)((0, import_GenericFunctions.getConditions)())]
          },
          {
